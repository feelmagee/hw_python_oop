...
class SportsWalking(Training):
    ...
    CONST_WLK_1: float = 0.035
    CONST_WLK_2: int = 2
    CONST_WLK_3: float = 0.029
    ...
    def get_spent_calories(self) -> float:
        ...
        return ((self.CONST_WLK_1 * self.weight
                + (self.get_mean_speed() ** self.CONST_WLK_2
                 // self.height) * self.CONST_WLK_3 * self.weight)
                * self.duration * self.MIN_IN_HOUR)
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return ((self.get_mean_speed() + self.CONST_SWM_1)
                * self.CONST_SWM_2 * self.weight)
